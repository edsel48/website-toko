...
<div class="flex justify-center flex-col gap-3">
    <div class="flex w-full justify-between items-center p-2 gap-10">
        ...
        <div class="right">
            <a href="{{route("supplier.create")}}" class="w-full">
                ...
                <tr>
                    ...
                    <td>
                        <div class="flex justify-end items-center gap-2 px-5">
                            <form action="{{ route("supplier.edit", $cat->id)}}" method="GET">
                            ...
                            <form action="{{ route("supplier.destroy", $cat->id)}}" method="POST">
                                @csrf
                                @method('delete')
